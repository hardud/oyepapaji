...
template <bool is_ad>
class DuplicateIsotropicPlasticityStressUpdateTempl : public RadialReturnStressUpdateTempl<is_ad>
{
public:
  static InputParameters validParams();

  DuplicateIsotropicPlasticityStressUpdateTempl(const InputParameters & parameters);
...
typedef DuplicateIsotropicPlasticityStressUpdateTempl<false>
    DuplicateIsotropicPlasticityStressUpdate;
typedef DuplicateIsotropicPlasticityStressUpdateTempl<true>
    ADDuplicateIsotropicPlasticityStressUpdate;

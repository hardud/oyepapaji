...
#include "DuplicateIsotropicPlasticityStressUpdate.h"

#include "Function.h"
#include "ElasticityTensorTools.h"

registerMooseObject("SolidMechanicsApp", ADDuplicateIsotropicPlasticityStressUpdate);
registerMooseObject("SolidMechanicsApp", DuplicateIsotropicPlasticityStressUpdate);

template <bool is_ad>
InputParameters
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::validParams()
{
...
template <bool is_ad>
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::DuplicateIsotropicPlasticityStressUpdateTempl(
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::initQpStatefulProperties()
{
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::propagateQpStatefulProperties()
{
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeStressInitialize(
...
template <bool is_ad>
GenericReal<is_ad>
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeResidual(
...
template <bool is_ad>
GenericReal<is_ad>
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeDerivative(
    const GenericReal<is_ad> & /*effective_trial_stress*/, const GenericReal<is_ad> & /*scalar*/)
{
  if (_yield_condition > 0.0)
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::iterationFinalize(
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeStressFinalize(
...
template <bool is_ad>
GenericReal<is_ad>
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeHardeningValue(
    const GenericReal<is_ad> & scalar)
{
...
template <bool is_ad>
GenericReal<is_ad>
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeHardeningDerivative(
    const GenericReal<is_ad> & /*scalar*/)
{
  if (_hardening_function)
  {
...
template <bool is_ad>
void
DuplicateIsotropicPlasticityStressUpdateTempl<is_ad>::computeYieldStress(
    const GenericRankFourTensor<is_ad> & /*elasticity_tensor*/)
{
...
template class DuplicateIsotropicPlasticityStressUpdateTempl<false>;
template class DuplicateIsotropicPlasticityStressUpdateTempl<true>;
